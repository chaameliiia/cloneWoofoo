    ...
    <>
      <header className="header fixed">
        ...
        <h1 className="header__logo">
          <a href="/" title="홈페이지 바로가기"><img src="/src/assets/img/img_logo.png" alt="로고" /></a>
        </h1>
      ...
      <div className="mainBox">
        ...
        <main className="reserve">
          ...
          <section className="reserve__box">
            ...
            <form action="/" method="post" className="reserve__box__form" id="reservation">
      ...
      <section className="support">
        ...
        <div className="support__descript">
          <img src="/src/assets/img/ic_support.png" alt="" />
          <span>우푸 서비스에 대한
          궁금증을 해결해 드립니다.</span>
        </div>
      ...
      <footer className="footer">
        ...
        <div className="footer__info">
          <img src="/src/assets/img/img_logoBottom.png" alt="" />
          <ul className="footer__info__serviceTerms">
            <li><a href="/" title="이용약관">이용약관</a></li>
            |
            <li><a href="/" title="개인정보 처리방침">개인정보 처리방침</a></li>
          </ul>
          <p className="footer__info__company">(주) 워키도기
            대표자: 김용재ㅣ개인정보책임자 : 조성득
        ...
        <ul className="footer__socialChannels">
          <li>
            <a href="/" title="네이버 블로그 바로가기">네</a>
          </li>
          <li>
            <a href="/" title="페이스북 바로가기">페</a>
          </li>
          <li>
            <a href="/" title="인스타그램 바로가기">인</a>
          </li>
        </ul>
        {/* <!-- 푸터 끝 --> */}
      </footer>
